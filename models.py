...
class User(Base):
    ...
    sno=Column(Integer,primary_key=True,autoincrement=True)
    emp_id=Column(String(6),unique=True)
...
class Otf(Base):
    ...
    status = Column(String(100))
    datentime = Column(DateTime)
    approved_empid = Column(String(100))
    approved_name = Column(String(100))
    approved_on = Column(DateTime)
    ch_empid = Column(String(10))
    ch_name = Column(String(100))
    ch_status = Column(String(100))
    ch_approved_on = Column(DateTime)
    branch = Column(String(100))
